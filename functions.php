...
wp_enqueue_script(
  ...
  /*
	|--------------------------------------------------------------------------
	| Скрипт для реализации функционала диалогового окна
	|--------------------------------------------------------------------------
	*/

wp_enqueue_script(
    'clean-dot-mobile-modals',
    clean_dot_asset_uri( '/js/components/modals.js' ),
    array(), // пустой массив = нет зависимостей
    clean_dot_asset_version( 'assets/js/components/modals.js' ),
    true
);
