      ...
      <div class="wrapper">
        <div class="hero__grid">
          <div class="hero__col -text">
            ...
            <p class="hero__text"><b>Важно:</b> мойка выполняется только для клиентов детейлинга — как обязательная
                ...
                <div class="basic-services-group__col">
                  ...
                  <article class="preview-card">
                    ...
                    <div class="preview-card__body">
                      ...
                      <p class="preview-card__description">Глубокая чистка ткани/кожи, удаление запахов,
            ...
            <div class="mini-quiz__grid">
              ...
              <div class="mini-quiz__col -main">
                <div class="mini-quiz-form">
                  <form action="">
                    <div class="mini-quiz-form__header">

                      <!-- отображается текущий шаг  -->
                      <div class="mini-quiz-form__status">
                        <p class="mini-quiz-label">
                          <b class="mini-quiz-label__accent">Шаг 1</b>из 3<span class="mini-quiz-label__time">~30
                            секунд</span>
                        </p>
                      </div>
                    </div>
                    <div class="mini-quiz-form__body">
                      <!-- Первый шаг  -->
                      <div class="mini-quiz-form__step">
                        <fieldset class="mini-quiz-options">
                          <legend class="mini-quiz-options__title">1. Что хотите сделать?</legend>
                          <ul class="mini-quiz-options__list">
                            <li class="mini-quiz-options__item">
                              <input class="visually-hidden" type="radio" name="what-you-want"
                                id="Pre-sale-preparation" />
                              <label class="mini-quiz-options__label" for="Pre-sale-preparation"><b>Предпродажная
                                  подготовка</b> быстро «в товарный вид»</label>
                            </li>

                            <li class="mini-quiz-options__item">
                              <input class="visually-hidden" type="radio" name="what-you-want"
                                id="Salon-dry-cleaning" />
                              <label class="mini-quiz-options__label" for="Salon-dry-cleaning"><b>Химчистка салона</b>
                                пятна / запах / освежить</label>
                            </li>

                            <li class="mini-quiz-options__item">
                              <input class="visually-hidden" type="radio" name="what-you-want" id="Car-polishing" />
                              <label class="mini-quiz-options__label" for="Car-polishing"><b>Полировка</b> убрать
                                «паутинку», блеск</label>
                            </li>

                            <li class="mini-quiz-options__item">
                              <input class="visually-hidden" type="radio" name="what-you-want" id="Ceramic-coating" />
                              <label class="mini-quiz-options__label" for="Ceramic-coating"><b>Керамика / стекло</b>
                                защита, гидрофоб</label>
                            </li>
                          </ul>
                        </fieldset>
                      </div>
                  ...
                  <article class="portfolio-preview-card">
                    <a href="./img/portfolio-preview-card/1.jpg" class="portfolio-preview-card__link"
                      ...
                      <div class="portfolio-preview-card__body">
                        ...
                        <p class="portfolio-preview-card__text">Выполнить полировку кузова автомобиля Hyundai Solaris
                          2022 с
                          последующим нанесением керамического покрытия для восстановления блеска, устранения мелких
                          царапин и
                    ...
                    <div class="portfolio-preview-card__album">
                      <a href="./img/portfolio-preview-card/1.jpg" data-fslightbox="portfolio-card-gallery-1"></a>
                      <a href="./img/portfolio-preview-card/1.jpg" data-fslightbox="portfolio-card-gallery-1"></a>
                      <a href="./img/portfolio-preview-card/1.jpg" data-fslightbox="portfolio-card-gallery-1"></a>
                      <a href="./img/portfolio-preview-card/1.jpg" data-fslightbox="portfolio-card-gallery-1"></a>
                      <a href="./img/portfolio-preview-card/1.jpg" data-fslightbox="portfolio-card-gallery-1"></a>
